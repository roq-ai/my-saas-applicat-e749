...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['fleet-owner', 'rental-provider', 'fleet-manager', 'customer-support'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Vehicle', path: '/vehicles', entity: 'vehicle', service: AccessServiceEnum.PROJECT, icon: FiBox },
